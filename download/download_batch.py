...
def parse_kinetics_annotations(input_csv, start_count, end_count):
    ...
    """
    df = pd.read_csv(input_csv)[start_count:end_count]
...
if __name__ == '__main__':
    ...
    p.add_argument('-s', '--start-count', type=int, default=0)
    p.add_argument('-e', '--end-count', type=int, default=10)
